		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMyAntlrActionAccess().getGroup(), "rule__MyAntlrAction__Group__0");
					put(grammarAccess.getMyAntlrActionAccess().getGroup_0(), "rule__MyAntlrAction__Group_0__0");
